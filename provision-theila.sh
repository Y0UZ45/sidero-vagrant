...
theila_tag="${1:-v0.2.1}"; shift || true

theila_image="ghcr.io/siderolabs/theila:$theila_tag"
...
ADD --chmod=755 https://github.com/siderolabs/theila/releases/download/$theila_tag/theila-linux-amd64 /theila
